...
<h:form>
	...
	<div>Availability:<h:inputText value="#{productController.inStock}"
						required="true"
						requiredMessage="Quantity in stock is mandatory"
						converterMessage="Availability must be a natural number"
						id="availability" /><h:message for="availability" />
	</div>
	...
	<div>
		<h:commandButton value="Submit"  action="#{productController.checkData}"/>
	</div></h:form>
	<h:form>
